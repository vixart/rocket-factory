...
func PaymentMethodModelToProto(pm model.PaymentMethod) paymentv1.PaymentMethod {
	switch pm {
...
func PaymentMethodProtoToModel(pm paymentv1.PaymentMethod) model.PaymentMethod {
	switch pm {
